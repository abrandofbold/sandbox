...
public class HelloWorldSWT {
	...
	final static String disclaimer = "The results of this window have no way of limiting the redraw of the window to less than they can display, thus setting the width too small will overflow the text from visibility";
